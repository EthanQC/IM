...
CREATE TABLE IF NOT EXISTS contacts (
    ...
    CONSTRAINT fk_contacts_friend FOREIGN KEY (friend_id) REFERENCES users(id) ON DELETE CASCADE
...
CREATE TABLE IF NOT EXISTS message_sequences (
    ...
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_seq_conv FOREIGN KEY (conversation_id) REFERENCES conversations(id) ON DELETE CASCADE
