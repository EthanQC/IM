...
const (
	...
	AuthService_LoginBySMS_FullMethodName   = "/auth.AuthService/LoginBySMS"
...
type AuthServiceClient interface {
	...
	LoginBySMS(ctx context.Context, in *SMSLoginRequest, opts ...grpc.CallOption) (*SMSLoginResponse, error)
...
func (c *authServiceClient) LoginBySMS(ctx context.Context, in *SMSLoginRequest, opts ...grpc.CallOption) (*SMSLoginResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AuthServiceServer interface {
	...
	LoginBySMS(context.Context, *SMSLoginRequest) (*SMSLoginResponse, error)
...
func (UnimplementedAuthServiceServer) LoginBySMS(context.Context, *SMSLoginRequest) (*SMSLoginResponse, error) {
...
func _AuthService_LoginBySMS_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).LoginBySMS(ctx, req.(*SMSLoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}
